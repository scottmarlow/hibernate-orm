...
package org.hibernate.bytecode.internal.javassist.proxy;
 ...
 * this default globally by setting static field {@link javassist.util.proxy.ProxyFactory#useCache} to false.
 * Caching may also be configured for a specific factory by calling instance method
 * {@link javassist.util.proxy.ProxyFactory#setUseCache(boolean)}. It is strongly recommended that new clients
 ...
 * method {@link javassist.util.proxy.ProxyFactory#setHandler(MethodHandler)} is called. This method was
 ...
 * {@link javassist.util.proxy.ProxyFactory#setHandler(MethodHandler)}.
 *
 ...
 * {@link javassist.util.proxy.ProxyFactory#useWriteReplace} to false. Alternatively, it may be
 * configured per factory by calling instance method {@link javassist.util.proxy.ProxyFactory#setUseWriteReplace(boolean)}.
 *
 * @see MethodHandler
 * @since 3.1
...
public class ProxyFactory {
    ...
    private static final String NULL_INTERCEPTOR_HOLDER = "org.hibernate.bytecode.internal.javassist.proxy.RuntimeSupport";
